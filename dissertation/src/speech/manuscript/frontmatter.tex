...
\documentclass[preprint, NumberedRefs]{JASAnew}\usepackage[]{graphicx}\usepackage[]{color}
...
\author{Michael Wehr}
\email{wehr@uoregon.edu}
\affiliation{University of Oregon, Institute of Neuroscience and Department of Psychology, Eugene, OR 97403, United States}
\date{\today}
